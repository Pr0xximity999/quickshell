...
Singleton{
    ...
    property AppearanceConfig.ItemWidth itemWidth: Config.appearance.itemWidth
    property AppearanceConfig.ContainerSize containerSize: Config.appearance.containerSize
